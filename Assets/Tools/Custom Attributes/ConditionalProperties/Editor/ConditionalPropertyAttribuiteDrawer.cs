...
[CustomPropertyDrawer(typeof(ConditionalPropertyAttribuite), true)]
public class ConditionalPropertyAttribuiteDrawer : PropertyDrawer
{
  ...
  BindingFlags.NonPublic | BindingFlags.Public)
    ...
    {
        var showIfAttribute = this.attribute as ConditionalPropertyAttribuite;
                 ...
                 label)
    {
        ...
        if (!meetsCondition && showIfAttribute.Action ==
                                       ActionOnConditionTrue.DontDraw)
            return 0;
           ...
           label)
    {
        ...
        var showIfAttribute = this.attribute as ConditionalPropertyAttribuite;
        if (showIfAttribute.Action == ActionOnConditionTrue.DontDraw)
        {
            return;
        }
        else if (showIfAttribute.Action == ActionOnConditionTrue.Disable)
        {
